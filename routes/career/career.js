...
// Careers Routes (Now render application forms directly)
app.get('/careers/register-business', (req, res) => {
    res.render('careers/register-business-form');
});

app.get('/careers/full-time', (req, res) => {
    res.render('careers/full-time-form');
});

app.get('/careers/part-time', (req, res) => {
    res.render('careers/part-time-form');
});

app.get('/careers/work-from-anywhere', (req, res) => {
    res.render('careers/work-from-anywhere-form');
});
